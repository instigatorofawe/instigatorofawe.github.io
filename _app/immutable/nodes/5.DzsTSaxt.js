import{t as e}from"../chunks/DK3Fl9T5.js";import{E as t,F as n,G as r,I as i,J as a,L as o,M as s,R as c,S as l,W as u,_ as d,b as f,c as p,d as m,g as h,h as g,j as _,m as v,v as y}from"../chunks/DW6VIfoF.js";import"../chunks/xihTtKlq.js";import{t as b}from"../chunks/BIJJvb5F.js";var x=`- title: 'Development and multicentre validation of the FLEX score: personalized preoperative surgical risk prediction using attention-based ICD-10 and Current Procedural Terminology set embeddings'
...
`,S=e({load:()=>C}),C=async()=>({publications:b(x)}),w=f(`<a target="_blank" rel="noopener noreferrer"> </a>`),T=f(`&middot; <a target="_blank" rel="noopener noreferrer">code</a>`,1),E=f(`<li><p class="title svelte-io22gx"><!></p> <p class="authors svelte-io22gx"></p> <p class="meta svelte-io22gx"><span class="journal svelte-io22gx"> </span> <!></p></li>`),D=f(`<ul class="publications svelte-io22gx"></ul>`);function O(e,n){var r=D();g(r,21,()=>n.publications,({title:e,authors:t,journal:n,year:r,doi:i,git:a})=>e,(e,n)=>{let r=()=>t(n).title,u=()=>t(n).authors,f=()=>t(n).journal,m=()=>t(n).year,g=()=>t(n).doi,_=()=>t(n).git;var b=E(),x=i(b),S=i(x),C=e=>{var t=w(),n=i(t,!0);a(t),s(()=>{p(t,`href`,`https://doi.org/${g()??``}`),d(n,r())}),y(e,t)},D=e=>{var t=l();s(()=>d(t,r())),y(e,t)};h(S,e=>{g()?e(C):e(D,-1)}),a(x);var O=c(x,2);v(O,u,!0),a(O);var k=c(O,2),A=i(k),j=i(A,!0);a(A);var M=c(A),N=c(M),P=e=>{var t=T(),n=c(o(t));s(()=>p(n,`href`,_())),y(e,t)};h(N,e=>{_()&&e(P)}),a(k),a(b),s(()=>{d(j,f()),d(M,`, ${m()??``} `)}),y(e,b)}),a(r),y(e,r)}var k=f(`<main><h1>Selected publications</h1> <p>For a complete list, see <a href="https://scholar.google.com/citations?user=bshgBtkAAAAJ&amp;hl=en" target="_blank">Google Scholar</a>.</p> <p style="text-align: right;">(*) denotes equal contribution</p> <!></main>`);function A(e,t){r(t,!0);var o=k();m(`1ix0gvc`,e=>{_(()=>{n.title=`Ran Liu - Publications`})}),O(c(i(o),6),{get publications(){return t.data.publications}}),a(o),y(e,o),u()}export{A as component,S as universal};